...
namespace ParseFlow\Exception;

/**
 * Exception for requests where no parser route can be planned.
 */
class UnsupportedParserRequestException extends ParserPlanningException {
}
