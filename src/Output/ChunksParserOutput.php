...
class ChunksParserOutput implements IParserOutput {

	public function __construct(private readonly ?string $format = 'rag', private readonly array $options = []) {}

	public function getType(): string { return 'chunks'; }
