...
use ParseFlow\Parser\Csv\CsvParserHelper;

class CsvToHtmlTableParser extends AbstractSingleRouteParser {

	protected function fromType(): string { return 'string'; }
	protected function fromFormat(): ?string { return 'csv'; }
	...
	protected function transform(mixed $value, ParserStepRequest $request): mixed {
		return \ParseFlow\Parser\Csv\CsvParserHelper::toHtmlTable($value);
	}
}
