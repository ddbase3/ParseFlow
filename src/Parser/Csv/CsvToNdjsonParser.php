...
class CsvToNdjsonParser extends AbstractSingleRouteParser {
	...
	protected function toFormat(): ?string { return 'ndjson'; }
	...
	protected function transform(mixed $value, ParserStepRequest $request): mixed {
		return \ParseFlow\Parser\Csv\CsvParserHelper::toNdjson($value);
	}
}
