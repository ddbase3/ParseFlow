...
class JpegToPngParser extends AbstractSingleRouteParser {

	protected function fromType(): string { return 'image'; }
	protected function fromFormat(): ?string { return 'jpeg'; }
	...
	protected function transform(mixed $value, ParserStepRequest $request): mixed {
		return \ParseFlow\Parser\Image\ImageParserHelper::jpegToPng($value);
	}
}
