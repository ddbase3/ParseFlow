...
class WebpToPngParser extends AbstractSingleRouteParser {

	protected function fromType(): string { return 'image'; }
	protected function fromFormat(): ?string { return 'webp'; }
	protected function toType(): string { return 'image'; }
	protected function toFormat(): ?string { return 'png'; }
	...
	protected function transform(mixed $value, ParserStepRequest $request): mixed {
		return \ParseFlow\Parser\Image\ImageParserHelper::webpToPng($value);
	}
}
