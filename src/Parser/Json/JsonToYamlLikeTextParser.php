...
class JsonToYamlLikeTextParser extends AbstractSingleRouteParser {
	...
	protected function toFormat(): ?string { return 'yaml'; }
	...
	protected function transform(mixed $value, ParserStepRequest $request): mixed {
		return \ParseFlow\Parser\Json\JsonParserHelper::toYamlText($value);
	}
}
