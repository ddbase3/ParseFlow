...
class DocxImagesToFilesParser extends AbstractSingleRouteParser {
	...
	protected function toFormat(): ?string { return 'image'; }
	...
	protected function transform(mixed $value, ParserStepRequest $request): mixed {
		return \ParseFlow\Parser\Office\OfficeOpenXmlParserHelper::docxImagesToFiles($value);
	}
}
