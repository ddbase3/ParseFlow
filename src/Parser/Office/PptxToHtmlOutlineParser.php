...
use ParseFlow\Parser\Office\OfficeOpenXmlParserHelper;

class PptxToHtmlOutlineParser extends AbstractSingleRouteParser {

	protected function fromType(): string { return 'document'; }
	protected function fromFormat(): ?string { return 'pptx'; }
	protected function toType(): string { return 'document'; }
	protected function toFormat(): ?string { return 'html'; }
	...
	protected function isAvailable(): bool {
		return class_exists(\ZipArchive::class) && class_exists('DOMDocument');
	}
	...
	protected function transform(mixed $value, ParserStepRequest $request): mixed {
		return \ParseFlow\Parser\Office\OfficeOpenXmlParserHelper::pptxToHtmlOutline($value);
	}
}
