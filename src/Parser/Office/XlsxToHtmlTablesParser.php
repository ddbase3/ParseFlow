...
class XlsxToHtmlTablesParser extends AbstractSingleRouteParser {

	protected function fromType(): string { return 'document'; }
	protected function fromFormat(): ?string { return 'xlsx'; }
	...
	protected function transform(mixed $value, ParserStepRequest $request): mixed {
		return \ParseFlow\Parser\Office\OfficeOpenXmlParserHelper::xlsxToHtmlTables($value);
	}
}
