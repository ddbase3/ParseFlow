...
class GeoJsonToKmlParser extends AbstractSingleRouteParser {

	protected function fromType(): string { return 'structured'; }
	protected function fromFormat(): ?string { return 'geojson'; }
	protected function toType(): string { return 'structured'; }
	protected function toFormat(): ?string { return 'kml'; }
	...
	protected function transform(mixed $value, ParserStepRequest $request): mixed {
		return \ParseFlow\Parser\Xml\XmlParserHelper::geoJsonToKml($value);
	}
}
