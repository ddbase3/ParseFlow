...
use ParseFlow\Parser\Xml\XmlParserHelper;

class SvgToHtmlPreviewParser extends AbstractSingleRouteParser {

	protected function fromType(): string { return 'image'; }
	protected function fromFormat(): ?string { return 'svg'; }
	...
	protected function requirements(): array {
		return ['simplexml', 'dom'];
	}

	protected function isAvailable(): bool {
		return function_exists('simplexml_load_string') && class_exists('DOMDocument');
	}
	...
	protected function transform(mixed $value, ParserStepRequest $request): mixed {
		return \ParseFlow\Parser\Xml\XmlParserHelper::svgToHtmlPreview($value);
	}
}
