...
class BinaryParserSource implements IParserSource {

	public function __construct(private readonly string $value, private readonly array $metadata = []) {}

	public function getType(): string { return 'binary'; }
	public function getValue(): string { return $this->value; }
	public function getMetadata(): array { return $this->metadata + ['size' => strlen($this->value)]; }
}
